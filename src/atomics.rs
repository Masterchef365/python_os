...
use rustpython_vm::common::static_cell::IPromiseTheresOnlyOneThread;
...
static IS_LOCKED: IPromiseTheresOnlyOneThread<Cell<bool>> = IPromiseTheresOnlyOneThread(Cell::new(false));
